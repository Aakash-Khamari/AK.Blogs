...
export default function HomeClient({ posts }) {
  ...
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-20 w-full bg-white dark:bg-[#0a0a0a] rounded-t-[3rem] shadow-[0_-20px_60px_-15px_rgba(0,0,0,0.1)] dark:shadow-[0_-20px_60px_-15px_rgba(255,255,255,0.05)] border-t border-neutral-100 dark:border-neutral-900">
