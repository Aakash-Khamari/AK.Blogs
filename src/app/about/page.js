...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-[#fcfbf9] dark:bg-[#0a0a0a] pb-32 pt-12">
      <div className="max-w-5xl mx-auto px-6 pt-12 pb-16">
        
        {/* Header */}
        <motion.div initial="hidden" animate="visible" variants={fadeUp} className="mb-20">
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-[1.1] mb-8 text-[#111] dark:text-white">
        ...
        <div className="space-y-24 text-[1.2rem] text-[#333] dark:text-neutral-300 leading-[1.9] font-medium">
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
              <div className="md:w-1/3">
                <div className="sticky top-32">
                  ...
                  <h2 className="text-3xl font-black text-[#111] dark:text-white">The Vision</h2>
                </div>
              </div>
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
              <div className="md:w-1/3">
                <div className="sticky top-32">
                  ...
                  <h2 className="text-3xl font-black text-[#111] dark:text-white">My Work</h2>
                </div>
              </div>
              <div className="md:w-2/3">
                <div className="grid gap-6">
                  {/* Portfolio Card 1 */}
                  <div className="bg-white dark:bg-[#111] p-8 rounded-[2rem] border border-neutral-100 dark:border-neutral-800 shadow-sm hover:shadow-md transition-all group cursor-pointer">
                    ...
                    <h3 className="text-2xl font-black text-[#111] dark:text-white mb-2 group-hover:text-blue-500 transition-colors">The Archive of Observations</h3>
                  ...
                  <div className="bg-white dark:bg-[#111] p-8 rounded-[2rem] border border-neutral-100 dark:border-neutral-800 shadow-sm hover:shadow-md transition-all group cursor-pointer">
                    ...
                    <h3 className="text-2xl font-black text-[#111] dark:text-white mb-2 group-hover:text-orange-500 transition-colors">The Notebook</h3>
