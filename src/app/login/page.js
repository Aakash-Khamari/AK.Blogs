...
export default function Login() {
  ...
  return (
    <main className="min-h-screen bg-[#fcfbf9] flex flex-col justify-center items-center px-6 pt-20">
      <div className="w-full max-w-md bg-white p-10 rounded-[2rem] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.05)] border border-neutral-100 text-center">
        ...
        <h1 className="text-3xl font-black tracking-tighter text-[#111] mb-2">
        ...
        {status === 'success' && !isSignUp ? (
          ...
          <form onSubmit={handleAuth} className="space-y-4 text-left">
            ...
            <button
              ...
              className="w-full px-8 py-4 bg-black text-white font-black uppercase tracking-widest rounded-xl hover:bg-neutral-800 transition disabled:opacity-50 mt-4"
            >
