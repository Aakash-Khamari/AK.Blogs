  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-[#0a0a0a] flex flex-col transition-colors duration-500">
      ...
      <div className="flex-1 max-w-6xl w-full mx-auto p-6 md:p-12">
        <div className="mb-10">
          <h1 className="text-3xl font-black text-[#111] dark:text-white mb-2">Platform Analytics</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white dark:bg-[#111] p-6 rounded-3xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
            ...
            <div className="text-4xl font-black text-[#111] dark:text-white">{usersCount || 0}</div>
            <div className="text-sm font-bold text-green-600 dark:text-green-400 mt-2 flex items-center gap-1">
          ...
          <div className="bg-white dark:bg-[#111] p-6 rounded-3xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
            ...
            <div className="text-4xl font-black text-[#111] dark:text-white">{totalViews}</div>
            <div className="text-sm font-bold text-green-600 dark:text-green-400 mt-2 flex items-center gap-1">
          ...
          <div className="bg-white dark:bg-[#111] p-6 rounded-3xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
            ...
            <div className="text-4xl font-black text-[#111] dark:text-white">{subsCount || 0}</div>
            <div className="text-sm font-bold text-neutral-400 mt-2 flex items-center gap-1">
              Newsletter Signups
            </div>
          </div>

          <div className="bg-neutral-100 dark:bg-neutral-900/50 p-6 rounded-3xl border border-neutral-200 dark:border-neutral-800 border-dashed shadow-sm opacity-60">
            <div className="flex items-center gap-3 text-neutral-500 mb-4">
              <Clock size={18} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-[#111] p-8 rounded-3xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
            ...
            <div className="space-y-6">
              {topPosts.length > 0 ? topPosts.map((post, i) => (
                <div key={i} className="flex justify-between items-center group">
                  <span className="font-bold text-[#111] dark:text-white group-hover:text-red-500 transition truncate pr-4">{post.title}</span>
          ...
          <div className="bg-neutral-100 dark:bg-neutral-900/50 p-8 rounded-3xl border border-neutral-200 dark:border-neutral-800 border-dashed shadow-sm opacity-60">
