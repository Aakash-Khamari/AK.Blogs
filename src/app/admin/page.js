...
export default async function AdminDashboard() {
  ...
  const { data: posts, error } = await supabase
    .from('posts')
    .select('id, title, category, published, created_at, views')
    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-10">
        <div>
          ...
          <p className="text-neutral-500 font-medium">Manage your stories and intellectual archive.</p>
        </div>
            ...
            {posts && posts.length > 0 ? (
              ...
              <tr>
                <td colSpan="5" className="px-6 py-12 text-center text-neutral-500 font-medium">
                  No stories yet. Time to write your first observation!
                </td>
              </tr>
            )}
          </tbody>
